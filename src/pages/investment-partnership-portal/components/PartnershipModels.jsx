              ...
              <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Button variant="default" size="default" fullWidth iconName="MessageSquare" iconPosition="left">
                      Discuss This Model
                    </Button>
                    <Button variant="outline" size="default" fullWidth iconName="FileText" iconPosition="left">
                      Download Details
                    </Button>
                  </div>
                </div>
