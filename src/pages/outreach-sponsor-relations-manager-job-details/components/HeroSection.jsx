      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">
            Outreach & Sponsor Relations Manager
          </h1>
          
          <p className="text-xl text-muted-foreground mb-8">
            Lead strategic partnerships and expand Marketverse's brand presence through innovative outreach campaigns and sponsor relationship management
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <div className="flex items-center gap-3 text-muted-foreground">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-foreground">Los Angeles / Remote</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 text-muted-foreground">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-foreground">5-7 Members</p>
              </div>
            </div>
