      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            Ready to Drive Growth with Marketverse?
          </h2>
          <p className="text-lg text-muted-foreground mb-8">
            Join our business development team and make a meaningful impact on our growth trajectory. Apply today or reach out to learn more about this exciting opportunity.
          </p>
          ...
          <div className="mt-12 pt-8 border-t border-border">
            <p className="text-sm text-muted-foreground mb-4">
              Questions about the role or application process?
            </p>
