  ...
  const steps = [
    {
      ...
      description: 'Complete online application with resume and cover letter',
      duration: '10-15 minutes'
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: 'Phone Screening',
      description: 'Brief phone interview with HR team to discuss experience and expectations',
      duration: '20-30 minutes'
    },
    {
      icon: <CheckCircle className="w-6 h-6" />,
      title: 'Skills Assessment',
      description: 'Practical assessment of MS Office skills and organizational abilities',
      duration: '45-60 minutes'
    },
    {
      icon: <Award className="w-6 h-6" />,
      title: 'Final Interview',
      description: 'In-person or video interview with operations manager',
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Straightforward evaluation process to assess your skills and fit
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Tell us about your administrative experience and why you're interested in this position..."
