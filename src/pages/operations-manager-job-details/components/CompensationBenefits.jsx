...
const CompensationBenefits = () => {
  const compensation = {
    salary: {
      range: '₹12,00,000 - ₹20,00,000',
      description: 'Competitive base salary based on experience and qualifications'
    },
    bonus: {
      range: '15-25%',
      description: 'Performance bonus tied to operational efficiency and KPI achievement'
    }
  };
  ...
  const benefits = [
    ...
    },
    {
      ...
      items: [
        'Operations management certification sponsorship',
    ...
    },
    {
      ...
      items: [
        ...
        '28 paid time off days annually',
        'Paid parental leave (maternity/paternity)',
        'Festival bonuses and special allowances'
      ]
    },
    {
      ...
      title: 'Career Growth',
      items: [
        'Clear progression to Director of Operations',
  ...
  const perks = [
    'Access to premium operations management tools',
    'Technology and equipment allowance',
    'Team building and training budget',
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Competitive executive-level package with performance incentives and comprehensive benefits supporting operational leadership
            </p>
          </div>
