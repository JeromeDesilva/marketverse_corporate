        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Join our leadership team and shape the operational future of Marketverse
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="bg-card border border-border rounded-xl p-6 text-center hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Submit your application with leadership portfolio
              </p>
              <Button
                variant="default"
                size="sm"
          ...
          <div className="bg-card border border-border rounded-xl p-8">
            <div className="text-center mb-6">
              ...
              <p className="text-muted-foreground">
                Subscribe to our careers newsletter for leadership opportunities and operational insights
              </p>
            </div>
