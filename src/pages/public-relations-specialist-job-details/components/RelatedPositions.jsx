...
const RelatedPositions = () => {
  const positions = [
    ...
    },
    {
      ...
      type: 'Full-time',
      description: 'Develop strategic partnerships with sponsors and brand ambassadors',
      link: '/outreach-sponsor-relations-manager-job-details'
    },
    {
      ...
      type: 'Full-time',
      description: 'Plan and execute corporate events, conferences, and brand activations',
      link: '#'
    }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Explore other opportunities in our marketing and communications team
            </p>
          </div>
