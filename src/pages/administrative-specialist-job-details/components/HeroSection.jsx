      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Entry-level administrative position designed for detail-oriented professionals seeking growth within Marketverse's structured environment through essential office support functions
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            ...
            <div className="flex items-center gap-3 text-muted-foreground">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-foreground">3-5 Members</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 text-muted-foreground">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-foreground">Entry Level</p>
              </div>
            </div>
          </div>
